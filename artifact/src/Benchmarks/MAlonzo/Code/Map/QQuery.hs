...
-- Map.Query.null
d_null_8 :: () -> () -> MAlonzo.Code.Map.Map.T_Map_176 -> Bool
d_null_8 ~v0 ~v1 v2 = du_null_8 v2
du_null_8 :: MAlonzo.Code.Map.Map.T_Map_176 -> Bool
du_null_8 v0
  = case coe v0 of
      MAlonzo.Code.Map.Map.C_tip_182
        -> coe MAlonzo.Code.Agda.Builtin.Bool.C_true_10
      MAlonzo.Code.Map.Map.C_node_184 v1 v2 v3 v4 v5
        -> coe MAlonzo.Code.Agda.Builtin.Bool.C_false_8
      _ -> MAlonzo.RTE.mazUnreachableError
-- Map.Query.size
d_size_14 :: MAlonzo.Code.Map.Map.T_Map_176 -> Integer
d_size_14 v0
  = case coe v0 of
      MAlonzo.Code.Map.Map.C_tip_182 -> coe (0 :: Integer)
      MAlonzo.Code.Map.Map.C_node_184 v1 v2 v3 v4 v5 -> coe v1
      _ -> MAlonzo.RTE.mazUnreachableError
-- Map.Query.lookup
d_lookup_22 ::
  () ->
  ...
  AgdaAny -> MAlonzo.Code.Map.Map.T_Map_176 -> Maybe AgdaAny
...
du_lookup_22 v0 v1 v2
  = case coe v2 of
      ...
      MAlonzo.Code.Map.Map.C_node_184 v3 v4 v5 v6 v7
        -> let v8 = coe MAlonzo.Code.Map.Map.d_compare_54 v0 v1 v4 in
           coe
             (case coe v8 of
...
d__'33''63'__82 ::
  ...
  () ->
  MAlonzo.Code.Map.Map.T_Comparable_44 ->
  MAlonzo.Code.Map.Map.T_Map_176 -> AgdaAny -> Maybe AgdaAny
...
d__'33'__92 ::
  ...
  () ->
  MAlonzo.Code.Map.Map.T_Comparable_44 ->
  MAlonzo.Code.Map.Map.T_Map_176 -> AgdaAny -> AgdaAny
...
du__'33'__92 v0 v1 v2
  = case coe v1 of
      ...
      MAlonzo.Code.Map.Map.C_node_184 v3 v4 v5 v6 v7
        -> let v8 = coe MAlonzo.Code.Map.Map.d_compare_54 v0 v2 v4 in
           coe
             (case coe v8 of
                MAlonzo.Code.Map.Map.C_eq_16 -> coe v5
                MAlonzo.Code.Map.Map.C_lt_18
...
d_findWithDefault_152 ::
  ...
  () ->
  MAlonzo.Code.Map.Map.T_Comparable_44 ->
  AgdaAny -> AgdaAny -> MAlonzo.Code.Map.Map.T_Map_176 -> AgdaAny
...
du_findWithDefault_152 v0 v1 v2 v3
  = case coe v3 of
      MAlonzo.Code.Map.Map.C_tip_182 -> coe v1
      MAlonzo.Code.Map.Map.C_node_184 v4 v5 v6 v7 v8
        -> let v9 = coe MAlonzo.Code.Map.Map.d_compare_54 v0 v2 v5 in
           coe
             (case coe v9 of
                MAlonzo.Code.Map.Map.C_eq_16 -> coe v6
                MAlonzo.Code.Map.Map.C_lt_18
...
d_member_222 ::
  ...
  () ->
  MAlonzo.Code.Map.Map.T_Comparable_44 ->
  AgdaAny -> MAlonzo.Code.Map.Map.T_Map_176 -> Bool
...
d_lookupLT_342 ::
  ...
  MAlonzo.Code.Map.Map.T_Comparable_44 ->
  AgdaAny ->
  MAlonzo.Code.Map.Map.T_Map_176 ->
  Maybe MAlonzo.Code.Map.Map.T_Pair_26
  ...
  = case coe v4 of
      MAlonzo.Code.Map.Map.C_tip_182
        -> coe
             ...
             (coe MAlonzo.Code.Map.Map.C__'44'__40 (coe v2) (coe v3))
      MAlonzo.Code.Map.Map.C_node_184 v5 v6 v7 v8 v9
        -> let v10 = coe MAlonzo.Code.Map.Map.d_compare_54 v0 v1 v2 in
           coe
             (let v11
           ...
           coe
             (case coe v8 of
                MAlonzo.Code.Map.Map.C_eq_16
                  -> coe
                       MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
                       (coe MAlonzo.Code.Map.Map.C__'44'__40 (coe v4) (coe v5))
                MAlonzo.Code.Map.Map.C_lt_18
  ...
  = case coe v4 of
      MAlonzo.Code.Map.Map.C_tip_182
        -> coe
             ...
             (coe MAlonzo.Code.Map.Map.C__'44'__40 (coe v2) (coe v3))
      MAlonzo.Code.Map.Map.C_node_184 v5 v6 v7 v8 v9
        -> let v10 = coe MAlonzo.Code.Map.Map.d_compare_54 v0 v1 v6 in
           coe
             (case coe v10 of
                MAlonzo.Code.Map.Map.C_eq_16
                  -> coe
                       MAlonzo.Code.Agda.Builtin.Maybe.C_just_16
                       (coe MAlonzo.Code.Map.Map.C__'44'__40 (coe v6) (coe v7))
                MAlonzo.Code.Map.Map.C_lt_18
